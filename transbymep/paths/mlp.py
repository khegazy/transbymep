...
class MLPpath(BasePath):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # output_sizes = [size * 2 for size in input_sizes[1:]] + [self.final_point.shape[-1]]
        # self.layers = [
        #     nn.Linear(
        ...
        # ]
        self.layers = [nn.Linear(1, self.final_point.shape[-1], dtype=torch.float64, bias=True)] + [ResNetLayer(self.final_point.shape[-1], n_embed, activation) for i in range(depth)]
